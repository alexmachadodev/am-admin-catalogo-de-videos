using AM.Codeflix.Catalog.Application.UseCases.Category.CreateCategory;
using AM.Codeflix.Catalog.Domain.Exceptions;
using FluentAssertions;
using Moq;
using DomainEntity = AM.Codeflix.Catalog.Domain.Entity;
using UseCases = AM.Codeflix.Catalog.Application.UseCases.Category.CreateCategory;

namespace AM.Codeflix.Catalog.UnitTests.Application.Category.CreateCategory;
